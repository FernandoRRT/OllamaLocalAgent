...
# Choosing the State Structure[](https://react.dev/learn/choosing-the-state-structure#undefined)
...
#### Don’t mirror props in state [](https://react.dev/learn/choosing-the-state-structure#don-t-mirror-props-in-state)
...
#### Improving memory usage [](https://react.dev/learn/choosing-the-state-structure#improving-memory-usage)
...
## Try out some challenges[](https://react.dev/learn/choosing-the-state-structure#challenges)
...
Fix a component that’s not updating [](https://react.dev/learn/choosing-the-state-structure#fix-a-component-thats-not-updating)
