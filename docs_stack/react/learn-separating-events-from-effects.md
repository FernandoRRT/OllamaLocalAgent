...
# Separating Events from Effects[](https://react.dev/learn/separating-events-from-effects#undefined)
...
App.js chat.js notifications.js
...
## Try out some challenges[](https://react.dev/learn/separating-events-from-effects#challenges)
