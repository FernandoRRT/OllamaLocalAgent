...
# You Might Not Need an Effect[](https://react.dev/learn/you-might-not-need-an-effect#undefined)
...
#### How to tell if a calculation is expensive? [](https://react.dev/learn/you-might-not-need-an-effect#how-to-tell-if-a-calculation-is-expensive)
...
## Try out some challenges[](https://react.dev/learn/you-might-not-need-an-effect#challenges)
...
Transform data without Effects [](https://react.dev/learn/you-might-not-need-an-effect#transform-data-without-effects)
