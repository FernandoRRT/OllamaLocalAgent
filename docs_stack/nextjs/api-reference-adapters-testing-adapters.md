...
## Custom deploy script contract[](https://nextjs.org/docs/app/api-reference/adapters/testing-adapters#custom-deploy-script-contract)
...
## Custom logs script contract[](https://nextjs.org/docs/app/api-reference/adapters/testing-adapters#custom-logs-script-contract)
...
## Custom cleanup script contract[](https://nextjs.org/docs/app/api-reference/adapters/testing-adapters#custom-cleanup-script-contract)
...
Previous API ReferenceNext Routing with @next/routing