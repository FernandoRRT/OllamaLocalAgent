...
### proxy.js API reference for the proxy.js file.### Backend for Frontend Learn how to use Next.js as a backend framework

Previous Route HandlersNext Deploying