...
## 1. Seed shell + postponed state at build time[](https://nextjs.org/docs/app/api-reference/adapters/implementing-ppr-in-an-adapter#1-seed-shell--postponed-state-at-build-time)
...
## 2. Runtime flow: serve cached shell and resume in background[](https://nextjs.org/docs/app/api-reference/adapters/implementing-ppr-in-an-adapter#2-runtime-flow-serve-cached-shell-and-resume-in-background)
...
## 3. Update cache with `requestMeta.onCacheEntryV2`[](https://nextjs.org/docs/app/api-reference/adapters/implementing-ppr-in-an-adapter#3-update-cache-with-requestmetaoncacheentryv2)
...
Previous Routing with @next/routingNext Runtime Integration