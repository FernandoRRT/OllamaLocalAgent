...
For component-level error recovery, the `unstable_catchError` function lets you create error boundaries that can wrap any part of your component tree:
...
### redirect API Reference for the redirect function.### error.js API reference for the error.js special file.### unstable_catchError API Reference for the unstable_catchError function.### notFound API Reference for the notFound function.### not-found.js API reference for the not-found.js file.

Previous RevalidatingNext CSS