...
## Pages (`outputs.pages`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#pages-outputspages)
...
## API Routes (`outputs.pagesApi`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#api-routes-outputspagesapi)
...
## App Pages (`outputs.appPages`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#app-pages-outputsapppages)
...
## App Routes (`outputs.appRoutes`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#app-routes-outputsapproutes)
...
## Prerenders (`outputs.prerenders`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#prerenders-outputsprerenders)
...
## Static Files (`outputs.staticFiles`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#static-files-outputsstaticfiles)
...
## Middleware (`outputs.middleware`)[](https://nextjs.org/docs/app/api-reference/adapters/output-types#middleware-outputsmiddleware)
...
Previous Invoking EntrypointsNext Routing Information