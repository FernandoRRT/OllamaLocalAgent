...
## Magic Comments[](https://nextjs.org/docs/app/guides/lazy-loading#magic-comments)
...
### `webpackIgnore` / `turbopackIgnore`[](https://nextjs.org/docs/app/guides/lazy-loading#webpackignore--turbopackignore)
...
### `turbopackOptional` (Turbopack only)[](https://nextjs.org/docs/app/guides/lazy-loading#turbopackoptional-turbopack-only)
...
Previous JSON-LDNext Development Environment