...
## Header Overriding Behavior[](https://nextjs.org/docs/app/api-reference/config/next-config-js/headers#header-overriding-behavior)
...
## Headers with basePath support[](https://nextjs.org/docs/app/api-reference/config/next-config-js/headers#headers-with-basepath-support)
...
## Headers with i18n support[](https://nextjs.org/docs/app/api-reference/config/next-config-js/headers#headers-with-i18n-support)
...
Previous generateEtagsNext htmlLimitedBots