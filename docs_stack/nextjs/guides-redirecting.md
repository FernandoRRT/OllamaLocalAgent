...
> *   `redirects` may have a limit on platforms. For example, on Vercel, there's a limit of 1,024 redirects. To manage a large number of redirects (1000+), consider creating a custom solution using Proxy. See managing redirects at scale for more.
...
### redirect API Reference for the redirect function.### permanentRedirect API Reference for the permanentRedirect function.### proxy.js API reference for the proxy.js file.### redirects Add redirects to your Next.js app.

Previous Public pagesNext Rendering Philosophy