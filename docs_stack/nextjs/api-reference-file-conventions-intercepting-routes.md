...
> **Good to know:** The `(..)` convention is based on _route segments_, not the file-system. For example, it does not consider `@slot` folders in Parallel Routes.
...
Previous instrumentation-client.jsNext layout.js