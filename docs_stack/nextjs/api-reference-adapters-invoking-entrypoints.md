...
## Node.js runtime (`runtime: 'nodejs'`)[](https://nextjs.org/docs/app/api-reference/adapters/invoking-entrypoints#nodejs-runtime-runtime-nodejs)
...
*   and `packages/next/src/build/templates/pages-api.ts`

## Edge runtime (`runtime: 'edge'`)[](https://nextjs.org/docs/app/api-reference/adapters/invoking-entrypoints#edge-runtime-runtime-edge)
...
*   and `packages/next/src/build/templates/middleware.ts`

Previous Runtime IntegrationNext Output Types