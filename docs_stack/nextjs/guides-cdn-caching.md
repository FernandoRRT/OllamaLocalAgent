...
## What Works Today[](https://nextjs.org/docs/app/guides/cdn-caching#what-works-today)

### Cache-Control headers[](https://nextjs.org/docs/app/guides/cdn-caching#cache-control-headers)
...
### Static assets[](https://nextjs.org/docs/app/guides/cdn-caching#static-assets)
...
### Static prefetches (PPR-enabled routes)[](https://nextjs.org/docs/app/guides/cdn-caching#static-prefetches-ppr-enabled-routes)
...
## Where CDN Caching Is Challenging[](https://nextjs.org/docs/app/guides/cdn-caching#where-cdn-caching-is-challenging)
...
> **Good to know:**`proxy.js` (previously Middleware) should run before the CDN cache so it remains the source of truth for auth, redirects, and rewrites. If your deployment places `proxy.js` behind the CDN, configure the cache layer to bypass caching for routes that depend on `proxy.js` decisions.
...
## Handling Headers at the CDN[](https://nextjs.org/docs/app/guides/cdn-caching#handling-headers-at-the-cdn)

### What you can safely ignore[](https://nextjs.org/docs/app/guides/cdn-caching#what-you-can-safely-ignore)
...
### What you must preserve[](https://nextjs.org/docs/app/guides/cdn-caching#what-you-must-preserve)
...
## Direction: Pathname-Based Cache Keying[](https://nextjs.org/docs/app/guides/cdn-caching#direction-pathname-based-cache-keying)
...
### How it works[](https://nextjs.org/docs/app/guides/cdn-caching#how-it-works)
...
### What changes for interception routes[](https://nextjs.org/docs/app/guides/cdn-caching#what-changes-for-interception-routes)
...
### Current status[](https://nextjs.org/docs/app/guides/cdn-caching#current-status)
...
## CDN Feature Compatibility[](https://nextjs.org/docs/app/guides/cdn-caching#cdn-feature-compatibility)
...
### Deploying to Platforms Understand which Next.js features require specific platform capabilities and how to choose the right deployment target.### Self-Hosting Learn how to self-host your Next.js application on a Node.js server, Docker image, or static HTML files (static exports).### Streaming Learn how streaming works in Next.js and how to use it to progressively render UI as data becomes available.### assetPrefix Learn how to use the assetPrefix config option to configure your CDN.

Previous Caching (Previous Model)Next CI Build Caching