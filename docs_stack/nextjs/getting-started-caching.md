...
## Enabling Cache Components[](https://nextjs.org/docs/app/getting-started/caching#enabling-cache-components)
...
## Usage[](https://nextjs.org/docs/app/getting-started/caching#usage)
...
### Data-level caching[](https://nextjs.org/docs/app/getting-started/caching#data-level-caching)
...
### UI-level caching[](https://nextjs.org/docs/app/getting-started/caching#ui-level-caching)
...
### Streaming uncached data[](https://nextjs.org/docs/app/getting-started/caching#streaming-uncached-data)
...
## Working with runtime APIs[](https://nextjs.org/docs/app/getting-started/caching#working-with-runtime-apis)
...
### Passing runtime values to cached functions[](https://nextjs.org/docs/app/getting-started/caching#passing-runtime-values-to-cached-functions)
...
## Working with non-deterministic operations[](https://nextjs.org/docs/app/getting-started/caching#working-with-non-deterministic-operations)
...
## Working with deterministic operations[](https://nextjs.org/docs/app/getting-started/caching#working-with-deterministic-operations)
...
## How rendering works[](https://nextjs.org/docs/app/getting-started/caching#how-rendering-works)
...
### Opting out of the static shell[](https://nextjs.org/docs/app/getting-started/caching#opting-out-of-the-static-shell)
...
### Putting it all together[](https://nextjs.org/docs/app/getting-started/caching#putting-it-all-together)
...
### Revalidating Learn how to revalidate cached data using time-based and on-demand strategies.### use cache Learn how to use the "use cache" directive to cache data in your Next.js application.### cacheComponents Learn how to enable the cacheComponents flag in Next.js.

Previous Mutating DataNext Revalidating