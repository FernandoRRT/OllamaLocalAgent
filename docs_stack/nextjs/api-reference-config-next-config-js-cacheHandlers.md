...
| `softTags` | `string[]` | Implicit tags derived from the route path. See Soft Tags for how to use them. |
...
## Distributed Tag Coordination[](https://nextjs.org/docs/app/api-reference/config/next-config-js/cacheHandlers#distributed-tag-coordination)
...
## Soft Tags[](https://nextjs.org/docs/app/api-reference/config/next-config-js/cacheHandlers#soft-tags)
...
## Handling Streams[](https://nextjs.org/docs/app/api-reference/config/next-config-js/cacheHandlers#handling-streams)
...
## Error Handling[](https://nextjs.org/docs/app/api-reference/config/next-config-js/cacheHandlers#error-handling)
...
### use cache Learn how to use the "use cache" directive to cache data in your Next.js application.### use cache: remote Learn how to use the "use cache: remote" directive for persistent, shared caching using remote cache handlers.### use cache: private Learn how to use the "use cache: private" directive to cache functions that access runtime request APIs.### cacheLife Learn how to set up cacheLife configurations in Next.js.

Previous cacheComponentsNext cacheLife