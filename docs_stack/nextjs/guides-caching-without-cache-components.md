...
## Caching `fetch` requests[](https://nextjs.org/docs/app/guides/caching-without-cache-components#caching-fetch-requests)
...
### `unstable_cache` for non-`fetch` functions[](https://nextjs.org/docs/app/guides/caching-without-cache-components#unstable_cache-for-non-fetch-functions)
...
### Route segment config[](https://nextjs.org/docs/app/guides/caching-without-cache-components#route-segment-config)

You can configure caching behavior at the route level by exporting config options from a Page, Layout, or Route Handler.

#### `dynamic`[](https://nextjs.org/docs/app/guides/caching-without-cache-components#dynamic)
...
##### Cross-route segment behavior[](https://nextjs.org/docs/app/guides/caching-without-cache-components#cross-route-segment-behavior)
...
## Time-based revalidation[](https://nextjs.org/docs/app/guides/caching-without-cache-components#time-based-revalidation)
...
### Route segment config `revalidate`[](https://nextjs.org/docs/app/guides/caching-without-cache-components#route-segment-config-revalidate)
...
#### Revalidation frequency[](https://nextjs.org/docs/app/guides/caching-without-cache-components#revalidation-frequency)
...
## On-demand revalidation[](https://nextjs.org/docs/app/guides/caching-without-cache-components#on-demand-revalidation)

To revalidate cached data after an event, use `revalidateTag` or `revalidatePath` in a Server Action or Route Handler.

### Tagging cached data[](https://nextjs.org/docs/app/guides/caching-without-cache-components#tagging-cached-data)
...
### `revalidateTag`[](https://nextjs.org/docs/app/guides/caching-without-cache-components#revalidatetag)
...
### `revalidatePath`[](https://nextjs.org/docs/app/guides/caching-without-cache-components#revalidatepath)
...
## Deduplicating requests[](https://nextjs.org/docs/app/guides/caching-without-cache-components#deduplicating-requests)
...
## Preloading data[](https://nextjs.org/docs/app/guides/caching-without-cache-components#preloading-data)
