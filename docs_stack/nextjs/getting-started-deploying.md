...
### Verified Adapters[](https://nextjs.org/docs/app/getting-started/deploying#verified-adapters)
...
### Other Platforms[](https://nextjs.org/docs/app/getting-started/deploying#other-platforms)
