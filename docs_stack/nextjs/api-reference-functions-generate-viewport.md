...
### Metadata Files API documentation for the metadata file conventions.### Caching Learn how to cache data and UI in Next.js### cacheComponents Learn how to enable the cacheComponents flag in Next.js.

Previous generateStaticParamsNext headers