...
## Supported platforms[](https://nextjs.org/docs/app/api-reference/turbopack#supported-platforms)
...
### Magic Comments[](https://nextjs.org/docs/app/api-reference/turbopack#magic-comments)
...
*   `experimental.turbopackFileSystemCacheForDev` is enabled by default
*   `experimental.turbopackFileSystemCacheForBuild` is currently opt-in
...
Previous Edge RuntimeNext Glossary