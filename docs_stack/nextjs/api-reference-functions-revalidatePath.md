...
## Using `revalidatePath` with rewrites[](https://nextjs.org/docs/app/api-reference/functions/revalidatePath#using-revalidatepath-with-rewrites)
...
### Revalidating a specific path[](https://nextjs.org/docs/app/api-reference/functions/revalidatePath#revalidating-a-specific-path)
