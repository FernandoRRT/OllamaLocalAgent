...
### Server Functions[](https://nextjs.org/docs/app/api-reference/config/next-config-js/logging#server-functions)
...
### Browser Console Logs[](https://nextjs.org/docs/app/api-reference/config/next-config-js/logging#browser-console-logs)
...
#### Options[](https://nextjs.org/docs/app/api-reference/config/next-config-js/logging#options-1)
...
#### Source Location[](https://nextjs.org/docs/app/api-reference/config/next-config-js/logging#source-location)
...
## Version History[](https://nextjs.org/docs/app/api-reference/config/next-config-js/logging#version-history)
