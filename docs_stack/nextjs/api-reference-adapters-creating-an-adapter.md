...
## Basic Adapter Structure[](https://nextjs.org/docs/app/api-reference/adapters/creating-an-adapter#basic-adapter-structure)
...
Previous ConfigurationNext API Reference