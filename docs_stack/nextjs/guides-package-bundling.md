...
*   `@next/bundle-analyzer` plugin for Webpack
...
### Production Recommendations to ensure the best performance and user experience before taking your Next.js application to production.

Previous OpenTelemetryNext PPR Platform Guide