...
## Why `generateMetadata` is Server Component only[](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#why-generatemetadata-is-server-component-only)
...
### Metadata Files API documentation for the metadata file conventions.### generateViewport API Reference for the generateViewport function.### Caching Learn how to cache data and UI in Next.js### cacheComponents Learn how to enable the cacheComponents flag in Next.js.

Previous generateImageMetadataNext generateSitemaps