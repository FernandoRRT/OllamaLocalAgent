...
## Caveats[](https://nextjs.org/docs/app/api-reference/edge#caveats)
...
## Reference[](https://nextjs.org/docs/app/api-reference/edge#reference)

The Edge Runtime supports the following APIs:

### Network APIs[](https://nextjs.org/docs/app/api-reference/edge#network-apis)
...
### Encoding APIs[](https://nextjs.org/docs/app/api-reference/edge#encoding-apis)
...
### Stream APIs[](https://nextjs.org/docs/app/api-reference/edge#stream-apis)
...
### Crypto APIs[](https://nextjs.org/docs/app/api-reference/edge#crypto-apis)
...
### Next.js Specific Polyfills[](https://nextjs.org/docs/app/api-reference/edge#nextjs-specific-polyfills)

*   `AsyncLocalStorage`

### Environment Variables[](https://nextjs.org/docs/app/api-reference/edge#environment-variables)

You can use `process.env` to access Environment Variables for both `next dev` and `next build`.

### Unsupported APIs[](https://nextjs.org/docs/app/api-reference/edge#unsupported-apis)
...
Previous Use CasesNext Turbopack