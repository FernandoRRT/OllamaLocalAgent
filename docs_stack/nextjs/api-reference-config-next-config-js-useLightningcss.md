...
## `lightningCssFeatures`[](https://nextjs.org/docs/app/api-reference/config/next-config-js/useLightningcss#lightningcssfeatures)
...
### Options[](https://nextjs.org/docs/app/api-reference/config/next-config-js/useLightningcss#options)
...
### Available features[](https://nextjs.org/docs/app/api-reference/config/next-config-js/useLightningcss#available-features)
...
Previous urlImportsNext viewTransition