...
## The Revalidation Model[](https://nextjs.org/docs/app/guides/how-revalidation-works#the-revalidation-model)
...
## What Gets Revalidated[](https://nextjs.org/docs/app/guides/how-revalidation-works#what-gets-revalidated)
...
### What happens if they get out of sync[](https://nextjs.org/docs/app/guides/how-revalidation-works#what-happens-if-they-get-out-of-sync)
...
## Tag System Architecture[](https://nextjs.org/docs/app/guides/how-revalidation-works#tag-system-architecture)

Next.js uses a tag-based system to track which cached content needs to be invalidated. There are two types of tags:

### Explicit tags[](https://nextjs.org/docs/app/guides/how-revalidation-works#explicit-tags)
...
### Soft tags[](https://nextjs.org/docs/app/guides/how-revalidation-works#soft-tags)
...
## Multi-Instance Considerations[](https://nextjs.org/docs/app/guides/how-revalidation-works#multi-instance-considerations)
...
## Implementation Patterns for Platforms[](https://nextjs.org/docs/app/guides/how-revalidation-works#implementation-patterns-for-platforms)

### Single instance[](https://nextjs.org/docs/app/guides/how-revalidation-works#single-instance)
...
### Multi-instance with shared cache[](https://nextjs.org/docs/app/guides/how-revalidation-works#multi-instance-with-shared-cache)
...
### CDN integration[](https://nextjs.org/docs/app/guides/how-revalidation-works#cdn-integration)
...
## Graceful Degradation[](https://nextjs.org/docs/app/guides/how-revalidation-works#graceful-degradation)
...
*   **Cross-deployment skew**: during rolling deployments, configure `deploymentId` so that a build ID change triggers a hard navigation to fetch consistent content.

Cache failures result in degraded performance (stale content, extra renders), not broken applications.

Related guides and references.

### Caching Learn how to cache data and UI in Next.js### ISR Learn how to create or update static pages at runtime with Incremental Static Regeneration.### cacheHandlers Configure custom cache handlers for use cache directives in Next.js.### revalidateTag API Reference for the revalidateTag function.

Previous FormsNext ISR