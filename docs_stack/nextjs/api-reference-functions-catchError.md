...
*   **Built-in error recovery** — `unstable_retry()` re-fetches and re-renders the error boundary's children, including Server Components.
...
## Reference[](https://nextjs.org/docs/app/api-reference/functions/catchError#reference)

### Parameters[](https://nextjs.org/docs/app/api-reference/functions/catchError#parameters)

`unstable_catchError` accepts a single argument:

`const ErrorWrapper = unstable_catchError(fallback)`

#### `fallback`[](https://nextjs.org/docs/app/api-reference/functions/catchError#fallback)
...
### Returns[](https://nextjs.org/docs/app/api-reference/functions/catchError#returns)
...
## Examples[](https://nextjs.org/docs/app/api-reference/functions/catchError#examples)

### Client Component[](https://nextjs.org/docs/app/api-reference/functions/catchError#client-component)
...
### Recovering from errors[](https://nextjs.org/docs/app/api-reference/functions/catchError#recovering-from-errors)
...
### Server-rendered error fallback[](https://nextjs.org/docs/app/api-reference/functions/catchError#server-rendered-error-fallback)
...
## Version History[](https://nextjs.org/docs/app/api-reference/functions/catchError#version-history)
...
### Error Handling Learn how to display expected errors and handle uncaught exceptions.### error.js API reference for the error.js special file.

Previous cacheTagNext connection