...
## Handler Context[](https://nextjs.org/docs/app/api-reference/adapters/runtime-integration#handler-context)
...
## PPR Chain Headers[](https://nextjs.org/docs/app/api-reference/adapters/runtime-integration#ppr-chain-headers)
