...
To better understand MCP server scope hierarchy and precedence in Claude Code, see their official documentation.
...
Wait for the terminal to print "🔍 MCP Inspector is up and running at http://127.0.0.1:6274". Navigate to this URL in your browser and set the following parameters:
