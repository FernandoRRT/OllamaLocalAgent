# Building extensible themes - Material UI
...
For components, use the array syntax to ensure that the variants, states, and pseudo-class styles from the branded theme are preserved.
...
Branded Button App Button App 2 Button
...
Cascade layersMinimizing bundle size
