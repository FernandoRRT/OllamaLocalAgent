...
Release notes Zod 4 release notes and new features including performance improvements and breaking changesIntro Introduction to Zod - TypeScript-first schema validation library with static type inference
