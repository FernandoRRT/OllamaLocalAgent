...
Customizing errors Guide to customizing validation error messages and error handling patternsMetadata and registries Attaching and manipulatinvg metadata on Zod schemas
